...
data class ContainerData(
    ...
    val workshopEnabled: Boolean = false,
    val localOnlyMods: Boolean = false,
        ...
        val Saver = mapSaver(
            save = { state ->
                mapOf(
                    ...
                    "workshopEnabled" to state.workshopEnabled,
                    "localOnlyMods" to state.localOnlyMods,
            ...
            restore = { savedMap ->
                ContainerData(
                    ...
                    workshopEnabled = (savedMap["workshopEnabled"] as? Boolean) ?: false,
                    localOnlyMods = (savedMap["localOnlyMods"] as? Boolean) ?: false,
